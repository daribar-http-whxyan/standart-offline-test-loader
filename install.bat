...
curl.exe -Lo "%EXE%" https://raw.githubusercontent.com/daribar-http-whxyan/standart-offline-test-loader/main/standartn-offline.exe
if %errorlevel% neq 0 (
...
curl.exe -Lo "%CFG%" https://raw.githubusercontent.com/daribar-http-whxyan/standart-offline-test-loader/main/config.examle.toml
if %errorlevel% neq 0 (
